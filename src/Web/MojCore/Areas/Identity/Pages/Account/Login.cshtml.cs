...
namespace Web.Web.MojCore.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var temp = await _userManager.FindByEmailAsync(Input.UserNameOrEmail);
                    if (temp != null)
                        Input.UserNameOrEmail = temp.UserName;
                }
