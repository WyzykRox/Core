...
namespace Web.Web.MojCore.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public IndexModel(UserManager<User> userManager, SignInManager<User> signInManager, IMessage emailSender)
        {
